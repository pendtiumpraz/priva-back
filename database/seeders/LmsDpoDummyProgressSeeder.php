...
class LmsDpoDummyProgressSeeder extends Seeder
{
    ...
    private function seedProgressForUser(
        ...
        $noteBodies = [
            'Catatan: prinsip purpose limitation berarti data pribadi hanya boleh diproses sesuai tujuan awal yang dideklarasikan ke subjek data. Wajib didokumentasikan di DPIA dan ROPA — kalau tujuan berubah, harus minta consent ulang atau dasar hukum baru sesuai Pasal 20 UU 27/2022 jo. PP 33/2026 Pasal 30.',
