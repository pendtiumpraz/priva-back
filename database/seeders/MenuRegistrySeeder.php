...
class MenuRegistrySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $menus = [
            ...
            ['menu_key' => 'sanctions', 'label' => 'Paparan Sanksi', 'href' => '/sanctions', 'icon' => 'Gavel', 'section' => 'PDP Modules', 'sort' => 157, 'roles' => array_merge(['root'], self::COMPLIANCE)],
            ['menu_key' => 'regulations', 'label' => 'Regulasi', 'href' => '/regulations', 'icon' => 'Scale', 'section' => 'PDP Modules', 'sort' => 158, 'roles' => ['admin', 'dpo']],
            ...
            ['menu_key' => 'due-diligence', 'label' => 'Due Diligence', 'href' => '/due-diligence', 'icon' => 'ShieldCheck', 'section' => 'Platform (Root)', 'sort' => 775, 'hideable' => false, 'roles' => self::PLATFORM_ROOT],
