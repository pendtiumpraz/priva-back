...
class MenuRegistryController extends Controller
{
    ...
    public function updateTenantOverride(Request $request)
    {
        ...
        if (! empty($data['tenant_role_id'])) {
            ...
            // Catatan: Menu Preferences TIDAK mengubah Role Settings (satu arah).
            // Arahnya kebalikan — Role Settings yang menyetir status Menu
            // Preferences untuk menu yang punya modul-permission (lihat
            // TenantRoleController::syncMenuOverridesToPermissions).
